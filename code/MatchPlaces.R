...
popdata <- read.csv("~/Dropbox/RStudioStuff/RStudioStuff/WorkingDocuments/SoulOfCommunity/SUB-EST00INT.csv")
sotc10 <- read.csv("~/Dropbox/RStudioStuff/RStudioStuff/WorkingDocuments/SoulOfCommunity/sotc10.csv")
places <- levels(sotc10$QSB)
...
placesPop <- data.frame(levels(sotc10$QSB), popdata[placesI, c(6:20)])
